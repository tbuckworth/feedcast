...
Here's a summary of Zvi Mowshowitz's post on Anthropic's major misuse report covering December twenty-twenty-five through August twenty-twenty-six.

Anthropic released an extensive report documenting disrupted misuse of Claude across seven categories: cyber operations, influence operations, surveillance, scams, biological misuse, conventional weapons development, and distillation. Zvi's overall read is surprisingly optimistic — if these are the worst cases, closed model misuse is more contained than expected.

The headline finding, and by far the most consequential, is systematic illicit distillation by major Chinese labs. Alibaba, Moonshot, DeepSeek, Zhipu, and Xiaomi all ran large-scale operations to extract Claude's capabilities. The methods were brazen: Moonshot and DeepSeek secretly forwarded their own users' queries directly to Claude and saved the exchanges for training data, and at least Moonshot returned Claude's responses to users as if they were its own model's outputs. Alibaba peaked at nearly three million exchanges per day through over thirty-five hundred fraudulent accounts, totaling over a hundred fifty-one million exchanges in just a few months. Zhipu tried to specifically distill Fable's cyber capabilities for an open model, though Fable's safeguards held and they had to fall back to Opus.

This involved chain-of-thought extraction attacks, stolen credit cards, fake accounts, and exposure of sensitive user data including from multinational companies and government-affiliated actors — all clearly illegal under multiple Chinese laws as well. Anthropic's countermeasures now include summarizing internal reasoning before responding rather than exposing raw chain of thought, plus classifiers to detect extraction patterns.

On the geopolitical front, this report has serious implications. A joint advisory from NSA, CISA, and FBI came out two days before the full report. China responded with threats of "resolute countermeasures." Ryan Fedasiuk argues this constitutes a major counterintelligence embarrassment for China's security services and will fundamentally alter the relationship between Chinese AI labs and the state. Separately, Zvi notes that Chinese labs were silently shipping consumer queries to Anthropic, including requests from China's security services. China Daily published an editorial framing calls to pace the frontier and the distillation report as coordinated American protectionism.

For the other threat categories, the picture is relatively reassuring. Cyber operations showed AI enabling unsophisticated actors to scale, including Russian espionage targeting Ukraine and opportunistic "vibe hacking" groups. Influence operations spanned nine cases across multiple countries but remained largely ineffective. Biological misuse cases were mostly dual-use research by scientists rather than the catastrophic uplift scenarios people worry about. Conventional weapons cases involved software development for guidance systems and drones, mainly from China, Russia, and Yemen. The scam category featured one memorable case: a network of twenty fake dating apps with forty-seven hundred AI personas talking to over twenty-five thousand real people.

Zvi also flags a critical breaking development: Trump explicitly declared AI existential risk a "hoax," which Zvi sees as a potentially irreversible rhetorical commitment that's very bad news, while urging the community not to make the response partisan.

The core takeaway: the misuse landscape for closed models is manageable, distillation is the real battlefield, and its geopolitical ramifications may prove more significant than the technical threat itself.

## Fidelity check

Status: revised
Claims: 42; flags: 6; material: 3

Flags on the draft:
- [contradicted, high] "It preceded an NSA, CISA, and FBI joint advisory" — The source states the NSA/CISA/FBI advisory came two days before the full report, meaning the report followed the advisory, not the reverse as the script claims. (source: "which is already an issue that was also covered by a joint advisory from NSA/CISA/FBI two days before the full report")
- [distorted, medium] "Moonshot and DeepSeek secretly forwarded their own users' queries directly to Claude, returned Claude's responses as if they were their own models' outputs" — The source explicitly hedges that only Moonshot (‘at least Moonshot’) is confirmed to have served Claude's outputs as its own; DeepSeek's behavior is described only as 'similar tactics' for relaying queries, not confirmed to include passing off responses as its own. (source: "At least Moonshot then gave the results back to its users as if these were Kimi outputs.")
- [distorted, medium] "Ryan Fedasiuk argues this constitutes a major counterintelligence embarrassment for China's security services, since Chinese labs were routing sensitive Chinese government queries to an American AI company." — The detail about queries from China's security services is Zvi's own commentary, not part of Ryan Fedasiuk's quoted argument, but the script attributes it to Fedasiuk. (source: "I do expect a substantial change in PRC's relationship with its top labs, after revelations that they silently shipped a lot of consumer queries directly to Anthropic, including requests from China's security services.")
- [distorted, low] "all clearly illegal under multiple Chinese laws" — The source hedges most legal claims with 'likely' (e.g., 'likely Criminal Law Art. 235a as well'), whereas the script states illegality as an unqualified fact. (source: "These practices are likely inconsistent with privacy laws and the labs' own terms of service.")
- [distorted, low] "which Zvi sees as a potentially irreversible rhetorical commitment" — The script drops Zvi's explicit hedges ('I fear', 'may have', conditional on future events) and states the claim as a firmer, more definite assessment. (source: "I fear he may have crossed a rhetorical Rubicon that will be difficult to step back from once he better understands the situation, and once future incidents change the game.")
- [distorted, low] "Biological misuse cases were mostly dual-use research by scientists rather than the catastrophic uplift scenarios people worry about." — The script characterizes all five cases uniformly as ambiguous dual-use research, but the source distinguishes two cases as clearly problematic and only three as more ambiguous. (source: "The first two cases seem like clear cases of Do Not Want, even if the people involved thought they were helping. The other three are less clear.")

Remaining after revision:
- [distorted, medium] "all clearly illegal under multiple Chinese laws as well" — Zvi hedges throughout ('looks like', 'likely broken', 'seems to apply') rather than stating flat illegality; the script drops these qualifiers and presents it as settled fact. (source: "All of this looks like it is in direct violation of numerous laws, including Chinese laws.")
- [distorted, medium] "Alibaba, Moonshot, DeepSeek, Zhipu, and Xiaomi all ran large-scale operations to extract Claude's capabilities" — Xiaomi's campaign was far smaller (~400k messages) than the others (millions to over a hundred million exchanges), so grouping it as equally 'large-scale' overstates its scope. (source: "This one was only ~400k messages, using saved user messages to seed the exchanges.")
...
The headline finding, and by far the most consequential, is systematic illicit distillation by major Chinese labs. Alibaba, Moonshot, DeepSeek, Zhipu, and Xiaomi all ran large-scale operations to extract Claude's capabilities. The methods were brazen: Moonshot and DeepSeek secretly forwarded their own users' queries directly to Claude, returned Claude's responses as if they were their own models' outputs, and saved the exchanges for training data. Alibaba peaked at nearly three million exchanges per day through over thirty-five hundred fraudulent accounts, totaling over a hundred fifty-one million exchanges in just a few months. Zhipu tried to specifically distill Fable's cyber capabilities for an open model, though Fable's safeguards held and they had to fall back to Opus.

This involved chain-of-thought extraction attacks, stolen credit cards, fake accounts, and exposure of sensitive user data including from multinational companies and government-affiliated actors — all clearly illegal under multiple Chinese laws as well. Anthropic's countermeasures now include summarizing internal reasoning before responding rather than exposing raw chain of thought, plus classifiers to detect extraction patterns.

On the geopolitical front, this report has serious implications. It preceded an NSA, CISA, and FBI joint advisory, and China responded with threats of "resolute countermeasures." Ryan Fedasiuk argues this constitutes a major counterintelligence embarrassment for China's security services, since Chinese labs were routing sensitive Chinese government queries to an American AI company. China Daily published an editorial framing calls to pace the frontier and the distillation report as coordinated American protectionism.
